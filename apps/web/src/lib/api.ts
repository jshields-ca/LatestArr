...
export interface Newsletter {
   ...
   * list. Only meaningful while templateId is unset. */
  introText: string | null;
  /** Free text shown near the bottom, above the "Generated by LatestArr"
   * line. Only meaningful while templateId is unset. */
  footerNote: string | null;
  /** Up to 4 call-to-action buttons rendered in the default template. */
  ctas: NewsletterCta[] | null;
  createdAt: string;
  updatedAt: string;
}
...
export function updateNewsletter(
  id: string,
  input: Omit<Partial<CreateNewsletterInput>, "templateId" | "smtpProfileId" | "introText" | "footerNote"> & {
    isEnabled?: boolean;
    templateId?: string | null;
    smtpProfileId?: string | null;
    introText?: string | null;
